...
![alt text]({{ site.baseurl }}/assets/images/notes/pricing_calc/image.png)
...
![alt text]({{ site.baseurl }}/assets/images/notes/pricing_calc/image-1.png)
...
![alt text]({{ site.baseurl }}/assets/images/notes/pricing_calc/image-2.png)

I have selected these services

![alt text]({{ site.baseurl }}/assets/images/notes/pricing_calc/image-3.png)

#### Virtual Machines config
![alt text]({{ site.baseurl }}/assets/images/notes/pricing_calc/image-4.png)

#### Azure SQL database config
![alt text]({{ site.baseurl }}/assets/images/notes/pricing_calc/image-5.png)

#### Application Gateway config
![alt text]({{ site.baseurl }}/assets/images/notes/pricing_calc/image-6.png)
