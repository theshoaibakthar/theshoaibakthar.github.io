...
![alt text]({{ site.baseurl }}/assets/images/notes/resource_lock/image.png)

---

### Task 3: Add a container to the storage account

![alt text]({{ site.baseurl }}/assets/images/notes/resource_lock/image-1.png)

You should receive an error message: Failed to create storage container.

![alt text]({{ site.baseurl }}/assets/images/notes/resource_lock/image-2.png)
...
![alt text]({{ site.baseurl }}/assets/images/notes/resource_lock/image-3.png)
...
![alt text]({{ site.baseurl }}/assets/images/notes/resource_lock/image-4.png)
...
![alt text]({{ site.baseurl }}/assets/images/notes/resource_lock/image-5.png)
