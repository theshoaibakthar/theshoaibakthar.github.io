...
!(/assets/images/notes/dataflowdercol/image.png)
...
![alt text]({{ site.baseurl }}/assets/images/notes/dataflowdercol/image-1.png)

Next, we're going to split our name column, for this we use a transformation called derived column.

![alt text]({{ site.baseurl }}/assets/images/notes/dataflowdercol/image-2.png)
...
![alt text]({{ site.baseurl }}/assets/images/notes/dataflowdercol/image-3.png)
...
![alt text]({{ site.baseurl }}/assets/images/notes/dataflowdercol/image-4.png)
