...
![alt text]({{ site.baseurl }}/assets/images/notes/dataflowcondflatten/img1.png) 


We need to set the sink options to output to single file and give a file name.


![alt text]({{ site.baseurl }}/assets/images/notes/dataflowcondflatten/img2.png) 
...
![alt text]({{ site.baseurl }}/assets/images/notes/dataflowcondflatten/img3.png)
