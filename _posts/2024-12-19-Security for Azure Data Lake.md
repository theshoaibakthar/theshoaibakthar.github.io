...
tags:
  - Azure
  - Data Lake
image: images/notes/datalake/security/image.png
toc: true
---
...
![alt text]({{ site.baseurl }}/assets/images/notes/datalake/security/image.png)
...
![alt text]({{ site.baseurl }}/assets/images/notes/datalake/security/image-1.png)

Right click directory and click manage acl

click add principal and search for a user to manage the access.

![alt text]({{ site.baseurl }}/assets/images/notes/datalake/security/image-2.png)

![alt text]({{ site.baseurl }}/assets/images/notes/datalake/security/image-3.png)
...
![alt text]({{ site.baseurl }}/assets/images/notes/datalake/security/image-4.png)

Now, assign the ACL permissions to the container "data" by clicking on manage ACL on the left settings

![alt text]({{ site.baseurl }}/assets/images/notes/datalake/security/image-5.png)
...
![alt text]({{ site.baseurl }}/assets/images/notes/datalake/security/image-6.png)

![alt text]({{ site.baseurl }}/assets/images/notes/datalake/security/image-7.png)

![alt text]({{ site.baseurl }}/assets/images/notes/datalake/security/image-8.png)
