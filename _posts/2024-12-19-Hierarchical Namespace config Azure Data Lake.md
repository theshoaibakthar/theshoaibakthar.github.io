...
tags:
  - Azure
  - Data Lake
image: images/notes/datalake/conf/image.png
toc: true
---
...
![alt text]({{ site.baseurl }}/assets/images/notes/datalake/conf/image.png)

Enable the hierarchical namespace to create a Data Lake

![alt text]({{ site.baseurl }}/assets/images/notes/datalake/conf/image-1.png)
...
![alt text]({{ site.baseurl }}/assets/images/notes/datalake/conf/image-2.png)

Go to the container and update the shared access tokens

![alt text]({{ site.baseurl }}/assets/images/notes/datalake/conf/image-3.png)

Click on Generate SAS token and URL

Create 2 directories in this container

![alt text]({{ site.baseurl }}/assets/images/notes/datalake/conf/image-4.png)
...
![alt text]({{ site.baseurl }}/assets/images/notes/datalake/conf/image-5.png)

![alt text]({{ site.baseurl }}/assets/images/notes/datalake/conf/image-6.png)
